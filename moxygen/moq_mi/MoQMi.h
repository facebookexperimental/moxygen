...
class MoQMi {
 public:
  ...
  enum class HeaderExtensionsTypeIDs : uint64_t {
    ...
    // 0x0B is reserved for Immutable extension type.
    MOQ_EXT_HEADER_TYPE_MOQMI_VIDEO_H264_IN_AVCC_METADATA = 0x15,
    MOQ_EXT_HEADER_TYPE_MOQMI_VIDEO_H264_IN_AVCC_EXTRADATA = 0x0D,
    MOQ_EXT_HEADER_TYPE_MOQMI_AUDIO_OPUS_METADATA = 0x0F,
    MOQ_EXT_HEADER_TYPE_MOQMI_TEXT_UTF8_METADATA = 0x11,
